...
use rand::Rng;
use serde::Serialize;
use share::{next_available_output_paths, plot_scatter_ascii};
...
fn main() {
    ...
    // Display data using ASCII plot
    plot_scatter_ascii(&xs, &ys, Some("Scatter Plot of Random Data with Noise"));
